  ...
  <div className=" shadow-lg rounded-lg p-0 lg:p-5 pb-12  post-card">
    ...
    <div className="block lg:flex text-center items-center justify-center mb-5 w-full">
      ...
      <div className="font-medium text-gray-700">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 inline mr-2 text-pink-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div className="text-center post-btn">
      <Link href={`/post/${post.slug}`}>
        <span className="transition duration-500 ease transform hover:-translate-y-1 inline-block bg-blue-600 text-sm font-semibold rounded-full text-white px-5 py-3 cursor-pointer">Continue Reading</span>
      </Link>
    </div>
  </div>
);
